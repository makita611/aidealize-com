(function () {
  ...
  s.textContent = [
    ...
    '.gas-radio-group{display:flex;flex-direction:column;gap:8px;padding:4px 0}',
    '.gas-radio-group label{display:flex;align-items:center;gap:8px;font-size:14px;cursor:pointer}',
